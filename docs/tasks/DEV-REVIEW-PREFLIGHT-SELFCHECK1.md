...
- 2026-08-02：`CLAIM-002` 認領後零進度——宣告的分支與 worktree 皆未建立、local lease 從未產生、
  兩項資源自認領起無任何 commit，lease 已於 08-01 21:00 過期。需求方指示改回 `📥Backlog` 之後再執行，
  以 `STATUS-003` 釋放認領（owner 轉待指派、iteration 歸零）。卡片範圍、驗收條件與紅線不變。
