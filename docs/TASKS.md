...
| [DOC-TESTING-GLOSSARY1](tasks/DOC-TESTING-GLOSSARY1.md) | — | T2 | Runbook 測試章節＋術語表 | 待指派（B2 獨立事實查核，須 ≠ 執行） | `ai/fable-5/DOC-TESTING-GLOSSARY1 @ .claude/worktrees/doc-testing-glossary1-execution` | 0 | 🔍待查核 | —不適用 | 2026-07-26T17:35:00+08:00 |
