...
| [DEV-EVENT-REPAIR-ANCHOR1](tasks/DEV-EVENT-REPAIR-ANCHOR1.md) | None | T3 | schema-repair 的歷史證據不可偽造 | Claude Opus 5@Claude Code（需求方指定執行；尚未認領） | `待認領` | 0 | ⏳待執行 | —不適用 | 2026-08-04T17:54:34+08:00 |
