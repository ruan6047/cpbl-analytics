...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | 待指派（跨模型家族或人工查核；統計紅線） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 4 | 🔍待查核 | —不適用 | 2026-07-30T09:46:30+08:00 |
