...
| [GAME-RECAP-PA1-FIX1](tasks/GAME-RECAP-PA1-FIX1.md) | INIT-GAME-RECAP | T4 | canonical PA 表的打席切分與出局數正確性 | Claude Fable 5@Claude Code（真 Fable 5） | `ai/fable-5/GAME-RECAP-PA1-FIX1 @ .claude/worktrees/fable-5-suitable-tasks-8aa8d9` | 4 | 🔍待查核 | ⏸未部署 | 2026-07-29T10:31:54+08:00 |
...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | 待指派 | — | 0 | 📥Backlog | —不適用 | 2026-07-29T09:18:09+08:00 |
...
| [ML-PITCHER-SCORELESS2](tasks/ML-PITCHER-SCORELESS2.md) | INIT-OFFICIAL-DATA1 | T3 | 提高連續無自責分尾段的採計率 | Claude Sonnet 5@Claude Code | `ai/opus-5/ML-PITCHER-SCORELESS2 @ .claude/worktrees/ml-pitcher-scoreless2-execution` | 4 | 🔍待查核 | ⏸未部署 | 2026-07-29T09:20:00+08:00 |
