...
| MATCHUP-DATA1 | 投打對決資料範圍與查詢 API 正確化 | ruan6047 | GPT-5@Codex（[`spec`](../matchups-redesign.md)） | GPT-5@Codex | 待指派（跨家族模型或人審） | `ai/codex/MATCHUP-DATA1` | 🔴 | 🔍待跨家族查核（57 tests＋真 DB 年度鏈路對帳綠） |
