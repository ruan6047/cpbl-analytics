...
|---|---|---|---|---|---|---|---|---|---|
| [BUG-HELD-GAME-FRESHNESS1](tasks/BUG-HELD-GAME-FRESHNESS1.md) | INIT-PRODUCT-UX | T4 | 保留比賽 completed 與 freshness 正確化 | ruan6047（push／部署／release） | `ai/gpt-5-codex/BUG-HELD-GAME-FRESHNESS1 @ .claude/worktrees/bug-held-game-freshness1-execution` | 1 | 📦已合併 | ⏸未部署 | 2026-07-19T22:45:00+08:00 |
| [DEP-PREDICT-LEGACY1](tasks/DEP-PREDICT-LEGACY1.md) | INIT-PRODUCT-UX | T3 | 舊預測體驗退場 | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-17T04:44:29+08:00 |
| [GAME-RECAP-PA1](tasks/GAME-RECAP-PA1.md) | INIT-GAME-RECAP | T4 | canonical 打席與逐球可靠對應 | 待需求方 ruan6047 核可契約與三卡切分（查核通過，待 Checkpoint） | `ai/gpt-5-codex/GAME-RECAP-PA1 @ .claude/worktrees/game-recap-pa1-execution` | 1 | ✅通過 | ⏸未部署 | 2026-07-19T20:50:00+08:00 |
