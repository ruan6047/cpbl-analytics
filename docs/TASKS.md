...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | Claude Fable 5@Claude Code（真 Fable 5；退回執行 iteration 3） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 2 | ↩退回 | —不適用 | 2026-07-30T01:05:00+08:00 |
