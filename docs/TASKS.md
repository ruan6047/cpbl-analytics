...
| [OPS-LIVE-SHADOW1](tasks/OPS-LIVE-SHADOW1.md) | — | T4 | VPS 隔離 live source observer | GPT-5.6@Codex（implementation；交付已查核） | `ai/codex/OPS-LIVE-SHADOW1 @ .claude/worktrees/ops-live-shadow1-execution（保留至 production 部署後結案）` | 1 | 🔍待查核 | ⏸未部署 | 2026-07-26T22:52:31+08:00 |
