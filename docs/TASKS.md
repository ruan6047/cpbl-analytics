...
| [DOC-WORKFLOW-ADOPT2](tasks/DOC-WORKFLOW-ADOPT2.md) | — | T1 | 採用 WF-18 canonical 流程強化＋F-01 歷史補帳 | 待指派（B2 校讀，須 ≠ 執行） | `main（T1 B2 直接 commit @ 9fbe64d）` | 0 | 🔍待查核 | —不適用 | 2026-07-26T19:20:41+08:00 |
