...
| [UI-FIELD-DIAGRAM1](tasks/UI-FIELD-DIAGRAM1.md) | INIT-PRODUCT-UX | T3 | 守備位置圖共用元件（轉播風排版） | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-21T01:50:00+08:00 |
| [UX-ABILITY-FIELD1](tasks/UX-ABILITY-FIELD1.md) | INIT-PRODUCT-UX | T4 | 能力值卡守備軸分母改為守備局數 | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-21T01:20:00+08:00 |
...
| [UX-PLAYER-FIELDVIZ1](tasks/UX-PLAYER-FIELDVIZ1.md) | INIT-PRODUCT-UX | T3 | 球員守備呈現（身分圖＋價值卡） | Claude（Opus 4.8） | `ai/opus-4-8/UX-PLAYER-FIELDVIZ1 @ .claude/worktrees/ux-player-fieldviz1-execution` | 1 | ↩退回 | ⏸未部署 | 2026-07-20T20:13:00+08:00 |
| [UX-PLAYER-IA2](tasks/UX-PLAYER-IA2.md) | INIT-PRODUCT-UX | T3 | 球員頁 IA 修訂（role 拆標籤＋守備獨立層） | Claude（Opus 4.8） | `ai/opus-4-8/UX-PLAYER-IA2 @ .claude/worktrees/ux-player-ia2-execution` | 2 | 🔍待查核 | ⏸未部署 | 2026-07-21T03:30:00+08:00 |
