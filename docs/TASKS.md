...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-REVIEW-PROMPT-GUARD1](tasks/DEV-REVIEW-PROMPT-GUARD1.md) | — | T2 | 查核提示詞產生器的三處錯誤指引 | Claude Opus 5@Claude Code | `ai/opus-5/DEV-REVIEW-PROMPT-GUARD1 @ .claude/worktrees/dev-review-prompt-guard1-execution` | 0 | 🔨執行中 | —不適用 | 2026-07-29T18:15:24+08:00 |
