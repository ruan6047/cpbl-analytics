...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-REVIEW-INDEP-FIELD1](tasks/DEV-REVIEW-INDEP-FIELD1.md) | — | T3 | 卡面獨立性要求改為機器可讀欄位 | Claude Opus 5@Claude Code | `ai/opus-5/DEV-REVIEW-INDEP-FIELD1 @ .claude/worktrees/dev-review-indep-field1-execution` | 1 | 🔨執行中 | —不適用 | 2026-07-30T10:27:17+08:00 |
...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | Claude Fable 5@Claude Code（真 Fable 5；退回執行 iteration 5） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 4 | ↩退回 | —不適用 | 2026-07-30T10:07:00+08:00 |
...
| [LIVE-GAME-BACKEND1](tasks/LIVE-GAME-BACKEND1.md) | INIT-OFFICIAL-DATA1 | T4 | 賽前情報與比賽中 live backend | GPT-5.6@Codex | `ai/codex/LIVE-GAME-BACKEND1 @ .claude/worktrees/live-game-backend1-execution` | 1 | ✅可合併 | ⏸未部署 | 2026-07-30T09:08:25+08:00 |
