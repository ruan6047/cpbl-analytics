...
| [DEV-REVIEW-PROMPT-GUARD1](tasks/DEV-REVIEW-PROMPT-GUARD1.md) | — | T2 | 查核提示詞產生器的三處錯誤指引 | ruan6047（merge gate；執行者代行 merge 須需求方授權） | `ai/opus-5/DEV-REVIEW-PROMPT-GUARD1 @ .claude/worktrees/dev-review-prompt-guard1-execution` | 3 | ✅可合併 | —不適用 | 2026-07-30T00:55:24+08:00 |
...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | Claude Fable 5@Claude Code（真 Fable 5；退回執行 iteration 3） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 2 | ↩退回 | —不適用 | 2026-07-30T01:40:00+08:00 |
...
| [LIVE-GAME-BACKEND1](tasks/LIVE-GAME-BACKEND1.md) | INIT-OFFICIAL-DATA1 | T4 | 賽前情報與比賽中 live backend | 待指派（跨模型家族或人工 T4 查核） | `ai/codex/LIVE-GAME-BACKEND1 @ .claude/worktrees/live-game-backend1-execution` | 1 | 🔍待查核 | ⏸未部署 | 2026-07-30T00:42:42+08:00 |
