...
| [DEV-REVIEW-PROMPT-BASE1](tasks/DEV-REVIEW-PROMPT-BASE1.md) | None | T2 | 查核提示詞在交付 SHA 的 worktree 內假性失敗 | Claude Opus 5@Claude Code | `ai/opus-5/DEV-REVIEW-PROMPT-BASE1 @ .claude/worktrees/adoring-taussig-0d71cb` | 1 | 🚧進行中 | —不適用 | 2026-08-04T16:36:28+08:00 |
