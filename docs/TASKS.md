...
| [UX-NAV-INTEGRATE1](tasks/UX-NAV-INTEGRATE1.md) | INIT-PRODUCT-UX | T2 | 全站多軸導覽欄整合重構（傘型：standings/batters/games…） | Opus 4.8（執行） | `claude/ux-nav-integrate1-af0daf @ .claude/worktrees/ux-player-scope1-audit-15cb43` | 1 | 🔨執行中 | ⏸未部署 | 2026-07-24T19:31:00+08:00 |
