...
| UX-7A | 球員頁換裝＋出手點＋PR 融入本季卡 | ruan6047 | Fable-5@Claude Code | Fable-5@Claude Code | 待指派 | `ai/fable/UX-7A` | ⚪ | 🔍待查核（範圍 v3 全數實作＋截圖驗證，07-13） |
...
- 執行：Fable-5@Claude Code（ruan6047 07-13 派工）　查核：待指派（旗艦頁建議人審或跨家族；一般卡同家族異 session 亦可）
...
- 狀態：🔍待查核　Commit：分支 `ai/fable/UX-7A`（worktree `../cpbl-analytics-ux-7a`，環境現成可照 §3.1 進駐審核）
