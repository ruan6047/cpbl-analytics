...
| [LIVE-GAME-BACKEND1](tasks/LIVE-GAME-BACKEND1.md) | INIT-OFFICIAL-DATA1 | T4 | 賽前情報與比賽中 live backend | ruan6047（決定 merge／deployment cutover） | `ai/codex/LIVE-GAME-BACKEND1 @ .claude/worktrees/live-game-backend1-execution` | 2 | ✅可合併 | ⏸未部署 | 2026-07-30T18:38:55+08:00 |
