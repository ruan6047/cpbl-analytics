...
| [DOC-WORKFLOW-ADOPT2](tasks/DOC-WORKFLOW-ADOPT2.md) | — | T1 | 採用 WF-18 canonical 流程強化＋F-01 歷史補帳 | Claude Fable 5@Claude Code | `main（T1 B2 直接 commit）` | 0 | 🔨執行中 | —不適用 | 2026-07-26T19:18:18+08:00 |
