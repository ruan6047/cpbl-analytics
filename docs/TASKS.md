...
| [INGEST-SPLITS-RECALC1](tasks/INGEST-SPLITS-RECALC1.md) | INIT-OFFICIAL-DATA1 | T4 | 修正分項重算的代打誤切重複計數並重建 | Claude Fable 5@Claude Code（開卡即依指示執行） | — | 0 | ⏳待執行 | ⏸未部署 | 2026-07-30T16:46:34+08:00 |
