...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-CI-RED-OWNERSHIP1](tasks/DEV-CI-RED-OWNERSHIP1.md) | None | T3 | main 紅燈無歸屬：「非本卡引入」沒有強制去向 | — | — | 0 | 🛑已停止 | —不適用 | 2026-08-04T22:39:10+08:00 |
| [DEV-EVENT-REPAIR-ANCHOR1](tasks/DEV-EVENT-REPAIR-ANCHOR1.md) | None | T3 | schema-repair 的歷史證據不可偽造 | — | — | 0 | 🛑已停止 | —不適用 | 2026-08-04T22:39:10+08:00 |
...
| [DEV-TRAILER-GUARD-PR-CHECKOUT1](tasks/DEV-TRAILER-GUARD-PR-CHECKOUT1.md) | None | T2 | trailer 守衛在 pull_request 觸發的 CI checkout 上恆定假陽性 | Claude Sonnet 5@Claude Code（退回原執行者） | `ai/claude-sonnet-5/DEV-TRAILER-GUARD-PR-CHECKOUT1 @ .claude/worktrees/dev-trailer-guard-pr-checkout1-execution` | 0 | ↩退回 | —不適用 | 2026-08-04T22:16:51+08:00 |
...
| [INGEST-SPLITS-IMPORT-RESTATE1](tasks/INGEST-SPLITS-IMPORT-RESTATE1.md) | INIT-OFFICIAL-DATA1 | T3 | 重建 2025 本土／外籍分項以吸收 bio 補值 | 待指派（跨家族查核；≠ 執行者；卡面 review_independence: [cross_family]） | `ai/opus-5/INGEST-SPLITS-IMPORT-RESTATE1 @ .claude/worktrees/ingest-splits-import-restate1-execution` | 1 | 🔍待查核 | ⏸未部署 | 2026-08-04T22:19:52+08:00 |
...
| [OPS-CODE-BRANCH-PROTECT1](tasks/OPS-CODE-BRANCH-PROTECT1.md) | WF-22 | T3 | 程式碼 main 的 branch protection 與 required checks | 待指派（建議 L2） | — | 0 | 📥Backlog | —不適用 | 2026-08-04T22:39:10+08:00 |
| [OPS-CONTROL-PLANE-PR-GUARD1](tasks/OPS-CONTROL-PLANE-PR-GUARD1.md) | None | T3 | 將 control-plane 轉為受保護 PR 的機械守衛 | — | — | 0 | 🛑已停止 | —不適用 | 2026-08-04T22:39:10+08:00 |
...
| [OPS-STATE-PLANE-MIG1](tasks/OPS-STATE-PLANE-MIG1.md) | WF-22 | T3 | 任務狀態面遷移至 GitHub Issues/Projects | Claude Sonnet 5@Claude Code | `ai/claude-sonnet-5/OPS-STATE-PLANE-MIG1 @ .claude/worktrees/ops-state-plane-mig1-execution` | 0 | 🚧進行中 | —不適用 | 2026-08-04T21:59:18+08:00 |
