...
|---|---|---|---|---|---|---|---|---|---|
| [GAME-RECAP-WP-STRENGTH1](tasks/GAME-RECAP-WP-STRENGTH1.md) | INIT-GAME-RECAP | T4 | 場中 WP 戰力感知先驗（VAL1 §7 路徑 2） | 退回原執行者（Claude Opus 5＝Coordinator 本人）於原分支修正（iteration 2） | `ai/opus-5/GAME-RECAP-WP-STRENGTH1 @ .claude/worktrees/game-recap-wp-strength1-execution` | 1 | 🔧修正中 | —不適用 | 2026-07-27T10:01:11+08:00 |
...
| [ML-OUTCOME-SIMPLE-LEAK2](tasks/ML-OUTCOME-SIMPLE-LEAK2.md) | — | T4 | 上線 serving 模型 outcome_simple 去洩漏與閘門重校 | 退回原執行者於原分支修正（iteration 2） | `ai/opus-5/ML-OUTCOME-SIMPLE-LEAK2 @ .claude/worktrees/ml-outcome-simple-leak2-execution` | 1 | 🔧修正中 | ⏸未部署 | 2026-07-27T09:44:59+08:00 |
