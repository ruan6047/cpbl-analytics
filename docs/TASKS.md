...
|---|---|---|---|---|---|---|---|---|---|
| [GAME-RECAP-WP-API1](tasks/GAME-RECAP-WP-API1.md) | INIT-GAME-RECAP | T3 | WP／WPA 參考資訊 API（揭露語意） | 待需求方 sign-off（spec §8.2）後才可 merge | `ai/fable-5/GAME-RECAP-WP-API1 @ .claude/worktrees/game-recap-wp-api1-execution` | 1 | 🔍待查核 | ⏸未部署 | 2026-07-27T02:20:36+08:00 |
