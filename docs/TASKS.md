...
| [ML-OUTCOME-SIMPLE-LEAK2](tasks/ML-OUTCOME-SIMPLE-LEAK2.md) | — | T4 | 上線 serving 模型 outcome_simple 去洩漏與閘門重校 | 待複驗（**須跨家族**；送 iteration 1/2 的 GPT 家族查核者） | `ai/opus-5/ML-OUTCOME-SIMPLE-LEAK2 @ .claude/worktrees/ml-outcome-simple-leak2-execution（基底 089a319，從未 merge main）` | 3 | 🔍待查核 | ⏸未部署 | 2026-07-27T12:10:18+08:00 |
