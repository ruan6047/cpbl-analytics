...
| [DOC-WORKFLOW-ADOPT1](tasks/DOC-WORKFLOW-ADOPT1.md) | — | T1 | 採用 WF-17 canonical 流程強化 | Claude Fable 5@Claude Code | `main（T1 B2 直接 commit）` | 0 | 🔨執行中 | —不適用 | 2026-07-26T16:37:00+08:00 |
...
| [OPS-PROCESS-GUARD1](tasks/OPS-PROCESS-GUARD1.md) | — | T2 | 流程守門機械化（review_prompt＋CI 前端測試） | 待指派（獨立輕量查核） | `ai/gpt-5/OPS-PROCESS-GUARD1 @ .claude/worktrees/ops-process-guard1-execution` | 1 | 🔍待查核 | —不適用 | 2026-07-26T16:35:00+08:00 |
