...
| [INGEST-PLAYER-BIO-GAP1](tasks/INGEST-PLAYER-BIO-GAP1.md) | INIT-OFFICIAL-DATA1 | T3 | 補齊 14 位球員的 country／birthday | 待指派（查核；≠ 執行者。獨立性下限見 review_prompt；卡面〈查核〉欄原文為「≠ 執行；輕量」，卡面缺 review_independence 欄位待需求方裁定） | `claude/ingest-player-bio-gap1-d85723 @ .claude/worktrees/ingest-player-bio-gap1-d85723` | 3 | 🔍待查核 | ⏸未部署 | 2026-08-03T18:35:00+08:00 |
