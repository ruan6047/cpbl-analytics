...
| [INGEST-SPLITS-RECALC1](tasks/INGEST-SPLITS-RECALC1.md) | INIT-OFFICIAL-DATA1 | T4 | 修正分項重算的代打誤切重複計數並重建 | Claude Fable 5@Claude Code（回傳原執行者；Phase P 部署待需求方裁定） | `ai/fable-5/INGEST-SPLITS-RECALC1 @ .claude/worktrees/ingest-splits-recalc1-execution` | 1 | 📦已合併 | ⏸未部署 | 2026-07-31T14:33:34+08:00 |
