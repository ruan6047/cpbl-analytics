...
| [DEV-REVIEW-PROMPT-GUARD1](tasks/DEV-REVIEW-PROMPT-GUARD1.md) | — | T2 | 查核提示詞產生器的三處錯誤指引 | 待指派（查核） | `ai/opus-5/DEV-REVIEW-PROMPT-GUARD1 @ .claude/worktrees/dev-review-prompt-guard1-execution` | 0 | 🔍待查核 | —不適用 | 2026-07-29T18:25:44+08:00 |
...
| [UX-ENTITY-LINKS2](tasks/UX-ENTITY-LINKS2.md) | INIT-PRODUCT-UX | T2 | 實體連結 pattern 普及化（整塊 hover:underline → ENTITY_LINK） | ruan6047（merge gate；執行者代行 merge 須需求方授權） | `ai/opus-5/UX-ENTITY-LINKS2 @ .claude/worktrees/ux-entity-links2-execution` | 1 | ✅可合併 | ⏸未部署 | 2026-07-29T20:11:08+08:00 |
