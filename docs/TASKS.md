...
| [UX-NAV-IA1](tasks/UX-NAV-IA1.md) | INIT-PRODUCT-UX | T3 | 方案 B 導覽與全域球員搜尋 | ruan6047（merge） | `ai/opus-4-8/UX-NAV-IA1 @ .claude/worktrees/ux-nav-ia1-execution-08c218` | 2 | ✅通過 | ⏸未部署 | 2026-07-17T14:00:00+08:00 |
| [UX-OUTCOME-HOME](tasks/UX-OUTCOME-HOME.md) | INIT-PRODUCT-UX | T4 | 可嵌入賽前勝率卡 | Fable-5@Claude Code（執行） | `ai/fable-5/UX-OUTCOME-HOME @ .claude/worktrees/cpbl-analytics-blueprint-a734ec` | 1 | 🔨執行中 | ⏸未部署 | 2026-07-17T13:50:00+08:00 |
