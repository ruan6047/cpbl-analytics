...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-REVIEW-INDEP-FIELD1](tasks/DEV-REVIEW-INDEP-FIELD1.md) | — | T3 | 卡面獨立性要求改為機器可讀欄位 | 待指派（查核；需求方指定 GPT@Codex） | `ai/opus-5/DEV-REVIEW-INDEP-FIELD1 @ .claude/worktrees/dev-review-indep-field1-execution` | 2 | 🔍待查核 | —不適用 | 2026-07-30T16:44:50+08:00 |
