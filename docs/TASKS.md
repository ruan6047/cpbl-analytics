...
| [INGEST-ADV-EXPAND1](tasks/INGEST-ADV-EXPAND1.md) | INIT-OFFICIAL-DATA1 | T4 | 進階排行榜維度與快照 additive schema | ruanruan（merge／production sign-off gate） | `ai/gpt-5-codex/INGEST-ADV-EXPAND1 @ .claude/worktrees/ingest-adv-expand1-execution` | 2 | ✅通過／待合併 | ⏸未部署 | 2026-07-23T01:04:34+08:00 |
