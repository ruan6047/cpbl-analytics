...
| [ML-OUTCOME-SIMPLE-LEAK2](tasks/ML-OUTCOME-SIMPLE-LEAK2.md) | — | T4 | 上線 serving 模型 outcome_simple 去洩漏與閘門重校 | 待複驗（**須跨家族**；iteration 4＋5 一併查核） | `ai/opus-5/ML-OUTCOME-SIMPLE-LEAK2 @ .claude/worktrees/ml-outcome-simple-leak2-execution（基底 089a319，從未 merge main）` | 5 | 🔍待查核 | ⏸未部署 | 2026-07-27T12:45:10+08:00 |
