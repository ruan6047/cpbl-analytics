...
|---|---|---|---|---|---|---|---|---|---|
| [BUG-ABILITY-DH-LABEL](tasks/BUG-ABILITY-DH-LABEL.md) | INIT-PRODUCT-UX | T3 | 能力卡守備軸誤標指打並填入力量 PR | Claude（Opus 4.8）（執行） | `ai/opus-4-8/BUG-ABILITY-DH-LABEL @ .claude/worktrees/bug-ability-dh-label-execution` | 1 | 🔍待查核 | ⏸未部署 | 2026-07-21T02:05:00+08:00 |
