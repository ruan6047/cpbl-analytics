...
| [ML-OUTCOME-SIMPLE-LEAK2](tasks/ML-OUTCOME-SIMPLE-LEAK2.md) | — | T3 | 上線 serving 模型 outcome_simple 去洩漏與閘門重校 | 待指派查核者（≠ 執行；**建議跨家族**——本卡核心是門檻變更的正當性） | `ai/opus-5/ML-OUTCOME-SIMPLE-LEAK2 @ .claude/worktrees/ml-outcome-simple-leak2-execution（基底 ai/opus-5/ML-OUTCOME-LEAK1 @ 089a319，從未 rebase 到 main）` | 1 | 🔍待查核 | ⏸未部署 | 2026-07-27T03:45:28+08:00 |
