...
| [DEV-REVIEW-PROMPT-GUARD1](tasks/DEV-REVIEW-PROMPT-GUARD1.md) | — | T2 | 查核提示詞產生器的三處錯誤指引 | 待指派（查核） | `ai/opus-5/DEV-REVIEW-PROMPT-GUARD1 @ .claude/worktrees/dev-review-prompt-guard1-execution` | 0 | 🔍待查核 | —不適用 | 2026-07-29T20:27:20+08:00 |
