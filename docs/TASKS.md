...
- 狀態：🔨 spec v5 **已核可**（07-11）；子卡進度：**UX-2/3/4/4.5/5B/5A/6 🏁完成、UX-7 群（7A/7B/7C）與 UX-9 🏁完成並於 07-14 合併/上線**（皆已 archive）、UX-8 ⏳待執行、UX-5C 📥（壓 UX-8 後）、UX-10 暫緩。本傘卡隨子卡全數結案後移 archive　Commit：—
