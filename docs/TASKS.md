...
| [ML-FIELD-TZ1](tasks/ML-FIELD-TZ1.md) | — | T4 | Total Zone 型守備指標可行性研究 | 待指派（查核 iteration 2） | `ai/opus-4-8/ML-FIELD-TZ1 @ .claude/worktrees/ml-field-tz1-execution` | 2 | 🔍待查核 | —不適用 | 2026-07-21T00:02:00+08:00 |
