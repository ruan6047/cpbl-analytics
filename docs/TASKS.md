...
| [ML-PITCHER-SCORELESS1](tasks/ML-PITCHER-SCORELESS1.md) | INIT-OFFICIAL-DATA1 | T3 | 投手連續無自責分局數（保守下界） | Claude Opus 5@Claude Code | `ai/opus-5/ML-PITCHER-SCORELESS1 @ .claude/worktrees/ml-pitcher-scoreless1-execution` | 3 | 🔍待查核 | ⏸未部署 | 2026-07-28T12:38:23+08:00 |
...
| [UX-TEAM-RECORDS1](tasks/UX-TEAM-RECORDS1.md) | INIT-PRODUCT-UX | T3 | 球隊頁「即將挑戰的紀錄」 | Claude Sonnet 5@Claude Code | `ai/sonnet-5/UX-TEAM-RECORDS1 @ .claude/worktrees/ux-team-records1-execution` | 1 | 🚧執行中 | ⏸未部署 | 2026-07-28T12:20:29+08:00 |
