...
| [DEV-REVIEW-PROMPT-GATE1](tasks/DEV-REVIEW-PROMPT-GATE1.md) | — | T2 | 中繼查核關卡被守衛當成本輪已結束 | 待指派（查核） | `ai/opus-5/DEV-REVIEW-PROMPT-GATE1 @ .claude/worktrees/dev-review-prompt-gate1-execution` | 0 | 🔍待查核 | —不適用 | 2026-07-30T08:08:29+08:00 |
...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | Claude Fable 5@Claude Code（Coordinator 重規劃中；spec v2 定稿後另立事件解除升級） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 3 | 🚨已升級 | —不適用 | 2026-07-30T09:13:00+08:00 |
