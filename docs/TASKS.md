...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-TRAILER-GUARD-SCOPE1](tasks/DEV-TRAILER-GUARD-SCOPE1.md) | — | T2 | trailer 守衛取樣範圍 | Claude Sonnet 5@Claude Code | `ai/sonnet-5/DEV-TRAILER-GUARD-SCOPE1 @ .claude/worktrees/dev-trailer-guard-scope1-execution` | 1 | 🚧執行中 | —不適用 | 2026-07-29T11:53:00+08:00 |
| [GAME-RECAP-PA1-FIX1](tasks/GAME-RECAP-PA1-FIX1.md) | INIT-GAME-RECAP | T4 | canonical PA 表的打席切分與出局數正確性 | Claude Fable 5@Claude Code（真 Fable 5） | `ai/fable-5/GAME-RECAP-PA1-FIX1 @ .claude/worktrees/fable-5-suitable-tasks-8aa8d9` | 5 | 🔍待查核 | ⏸未部署 | 2026-07-29T11:59:15+08:00 |
