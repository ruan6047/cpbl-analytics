...
|---|---|---|---|---|---|---|---|---|---|
| [GAME-RECAP-WP-STRENGTH1](tasks/GAME-RECAP-WP-STRENGTH1.md) | INIT-GAME-RECAP | T4 | 場中 WP 戰力感知先驗（VAL1 §7 路徑 2） | 待執行者續修（排在 ML-OUTCOME-SIMPLE-LEAK2 之後） | `ai/opus-5/GAME-RECAP-WP-STRENGTH1 @ .claude/worktrees/game-recap-wp-strength1-execution` | 3 | 🔧修正中 | —不適用 | 2026-07-27T12:02:18+08:00 |
...
| [ML-OUTCOME-LEAK1](tasks/ML-OUTCOME-LEAK1.md) | — | T3 | 賽果預測先發特徵前視洩漏修正 | ⛔ 部署凍結中（待 ML-OUTCOME-SIMPLE-LEAK2 完成後同批上線） | `ai/opus-5/ML-OUTCOME-LEAK1 @ .claude/worktrees/ml-outcome-leak1-execution（保留：LEAK2 分支以此為基底）` | 1 | 📦已合併 | ⏸未部署 | 2026-07-27T03:30:41+08:00 |
| [ML-OUTCOME-SIMPLE-LEAK2](tasks/ML-OUTCOME-SIMPLE-LEAK2.md) | — | T4 | 上線 serving 模型 outcome_simple 去洩漏與閘門重校 | Coordinator（待需求方授權 merge） | `ai/opus-5/ML-OUTCOME-SIMPLE-LEAK2 @ .claude/worktrees/ml-outcome-simple-leak2-execution` | 7 | ✅可合併 | ⏸未部署 | 2026-07-27T14:40:28+08:00 |
...
| [ML-WP-BIO-PRIOR1](tasks/ML-WP-BIO-PRIOR1.md) | INIT-GAME-RECAP | T3 | WP 賽前先驗 bio 方向研究 spike | 待指派 | — | 0 | 📥Backlog | —不適用 | 2026-07-27T01:29:31+08:00 |
...
| [UX-PREGAME-SOURCE-GUARD1](tasks/UX-PREGAME-SOURCE-GUARD1.md) | — | T2 | 賽前勝率單一來源守衛改為自動反查 | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-27T14:12:52+08:00 |
