...
| [DEV-EVENT-SCHEMA-GUARD1](tasks/DEV-EVENT-SCHEMA-GUARD1.md) | None | T3 | event log 寫入端無 schema 把關，壞資料會永久卡住 ledger | 待指派（≠ 執行者 Claude 家族；卡面 review_independence: [cross_family]） | `ai/opus-5/DEV-EVENT-SCHEMA-GUARD1 @ /private/tmp/cpbl-schema-guard` | 1 | 🔍待查核 | —不適用 | 2026-08-03T13:05:00+08:00 |
