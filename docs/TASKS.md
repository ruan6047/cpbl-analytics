...
| [UX-BRAND-HOME1-FIX1](tasks/UX-BRAND-HOME1-FIX1.md) | INIT-PRODUCT-UX | T2 | description metadata 未隨品牌與副標收斂 | ruan6047（merge gate；代行 merge 須需求方授權） | `ai/opus-5/UX-BRAND-HOME1-FIX1 @ /private/tmp/cpbl-brand-fix1` | 1 | ✅可合併 | ⏸未部署 | 2026-08-03T12:10:00+08:00 |
