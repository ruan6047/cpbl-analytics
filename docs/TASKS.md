...
| [INGEST-SPLITS-IMPORT-RESTATE1](tasks/INGEST-SPLITS-IMPORT-RESTATE1.md) | INIT-OFFICIAL-DATA1 | T3 | 重建 2025 本土／外籍分項以吸收 bio 補值 | 待指派（Coordinator；merge 者不得為執行者） | `ai/opus-5/INGEST-SPLITS-IMPORT-RESTATE1 @ .claude/worktrees/ingest-splits-import-restate1-execution` | 1 | ✅可合併 | ⏸未部署 | 2026-08-04T22:44:21+08:00 |
