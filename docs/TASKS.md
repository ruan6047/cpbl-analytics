...
| [UX-ENTITY-LINKS3](tasks/UX-ENTITY-LINKS3.md) | INIT-PRODUCT-UX | T3 | 賽事情境的隊名連結化（範圍收斂為 A 層） | ruan6047（merge gate；執行者代行 merge 須需求方授權） | `ai/opus-5/UX-ENTITY-LINKS3 @ .claude/worktrees/ux-entity-links3-execution` | 0 | ✅可合併 | ⏸未部署 | 2026-07-29T22:43:44+08:00 |
