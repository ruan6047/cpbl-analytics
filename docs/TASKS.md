...
| [DEV-CI-SCORELESS-DB-SKIP1](tasks/DEV-CI-SCORELESS-DB-SKIP1.md) | None | T2 | CI api job 因單一測試未循同檔案模式 skip DB 不可用而長紅 | 待指派（Coordinator；merge 者不得為執行者） | `ai/claude-sonnet-5/DEV-CI-SCORELESS-DB-SKIP1 @ .claude/worktrees/upbeat-mayer-1840be` | 0 | ✅可合併 | —不適用 | 2026-08-04T19:27:35+08:00 |
