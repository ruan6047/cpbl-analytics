...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-BASELINE-GUARD-DECL1](tasks/DEV-BASELINE-GUARD-DECL1.md) | None | T2 | spec 基線守衛只認宣告值，說明文字不再放行 | 待指派（Coordinator；merge 者不得為執行者） | `ai/opus-5/DEV-BASELINE-GUARD-DECL1 @ .claude/worktrees/adoring-taussig-0d71cb` | 2 | ✅可合併 | —不適用 | 2026-08-04T16:17:22+08:00 |
