...
| [DEV-REVIEW-PROMPT-BASE1](tasks/DEV-REVIEW-PROMPT-BASE1.md) | None | T2 | 查核提示詞在交付 SHA 的 worktree 內假性失敗 | 待指派（查核；≠ 執行者。卡面 review_independence: [context]） | `ai/opus-5/DEV-REVIEW-PROMPT-BASE1 @ .claude/worktrees/adoring-taussig-0d71cb` | 1 | 🔍待查核 | —不適用 | 2026-08-04T16:41:01+08:00 |
