...
| [DEV-TRAILER-GUARD-PR-CHECKOUT1](tasks/DEV-TRAILER-GUARD-PR-CHECKOUT1.md) | None | T2 | trailer 守衛在 pull_request 觸發的 CI checkout 上恆定假陽性 | Claude Sonnet 5@Claude Code | `ai/claude-sonnet-5/DEV-TRAILER-GUARD-PR-CHECKOUT1 @ .claude/worktrees/dev-trailer-guard-pr-checkout1-execution` | 0 | 🚧進行中 | —不適用 | 2026-08-04T20:07:32+08:00 |
...
| [INGEST-PLAYER-BIO-GAP2](tasks/INGEST-PLAYER-BIO-GAP2.md) | INIT-OFFICIAL-DATA1 | T2 | 補齊 14 人的 handedness 與 batch 2 其餘 bio 欄 | 待指派（查核；≠ 執行者。卡面 review_independence: [context]） | `ai/opus-5/INGEST-PLAYER-BIO-GAP2 @ .claude/worktrees/ingest-player-bio-gap2-execution` | 1 | 🔍待查核 | ⏸未部署 | 2026-08-03T19:42:21+08:00 |
