...
|---|---|---|---|---|---|---|---|---|---|
| [DEV-REVIEW-PROMPT-GATE1](tasks/DEV-REVIEW-PROMPT-GATE1.md) | — | T2 | 中繼查核關卡被守衛當成本輪已結束 | 待指派（查核） | `ai/opus-5/DEV-REVIEW-PROMPT-GATE1 @ .claude/worktrees/dev-review-prompt-gate1-execution` | 0 | 🔍待查核 | —不適用 | 2026-07-29T19:42:08+08:00 |
| [DEV-REVIEW-PROMPT-GUARD1](tasks/DEV-REVIEW-PROMPT-GUARD1.md) | — | T2 | 查核提示詞產生器的三處錯誤指引 | Claude Opus 5@Claude Code | `ai/opus-5/DEV-REVIEW-PROMPT-GUARD1 @ .claude/worktrees/dev-review-prompt-guard1-execution` | 0 | ↩退回 | —不適用 | 2026-07-29T20:40:58+08:00 |
...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | Claude Fable 5@Claude Code（真 Fable 5） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/fable-5-suitable-tasks-8aa8d9` | 1 | ↩退回 | —不適用 | 2026-07-29T20:11:28+08:00 |
...
| [OPS-BACKUP-EMPTY1](tasks/OPS-BACKUP-EMPTY1.md) | — | T3 | 生產每日備份長期產出空檔 | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-29T15:05:00+08:00 |
...
| [UX-ENTITY-LINKS2](tasks/UX-ENTITY-LINKS2.md) | INIT-PRODUCT-UX | T2 | 實體連結 pattern 普及化（整塊 hover:underline → ENTITY_LINK） | ruan6047（部署驗證） | `ai/opus-5/UX-ENTITY-LINKS2 @ .claude/worktrees/ux-entity-links2-execution` | 1 | 📦已合併 | ⏸未部署 | 2026-07-29T20:15:55+08:00 |
| [UX-ENTITY-LINKS3](tasks/UX-ENTITY-LINKS3.md) | INIT-PRODUCT-UX | T3 | 賽事情境的隊名連結化（範圍收斂為 A 層） | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-29T18:00:45+08:00 |
...
| [UX-LEADERS-ORPHAN1](tasks/UX-LEADERS-ORPHAN1.md) | INIT-PRODUCT-UX | T2 | LeagueLeaders 元件已無 runtime consumer | 待指派 | — | 0 | 📥Backlog | ⏸未部署 | 2026-07-29T20:33:30+08:00 |
