...
| [DEV-EVENT-SCHEMA-GUARD1](tasks/DEV-EVENT-SCHEMA-GUARD1.md) | None | T3 | event log 寫入端無 schema 把關，壞資料會永久卡住 ledger | Antigravity AI（Gemini 3.6 Flash）（原查核者複審為佳） | `ai/opus-5/DEV-EVENT-SCHEMA-GUARD1 @ /private/tmp/cpbl-schema-guard` | 4 | 🔍待查核 | —不適用 | 2026-08-03T17:15:00+08:00 |
