...
| [INGEST-ADV-EXPAND1](tasks/INGEST-ADV-EXPAND1.md) | INIT-OFFICIAL-DATA1 | T4 | 進階排行榜維度與快照 additive schema | ruanruan（production sign-off） | `ai/gpt-5-codex/INGEST-ADV-EXPAND1 @ .claude/worktrees/ingest-adv-expand1-execution` | 2 | 📦已合併 | 🚀待部署 | 2026-07-23T01:09:30+08:00 |
