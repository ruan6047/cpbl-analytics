...
| [LIVE-SNAPSHOT-FIELDS1](tasks/LIVE-SNAPSHOT-FIELDS1.md) | INIT-PRODUCT-UX | T3 | canonical snapshot 保留官方既有欄位 | 待指派（跨模型家族獨立查核；須 ≠ 執行者 Claude 家族） | `ai/opus-5/LIVE-SNAPSHOT-FIELDS1 @ /tmp/cpbl-fields1` | 2 | 🔍待查核 | ⏸未部署 | 2026-08-01T14:55:03+08:00 |
