...
| [OPS-LIVE-SHADOW1-FIX1](tasks/OPS-LIVE-SHADOW1-FIX1.md) | — | T4 | 完賽場停止輪詢以保留 A-228 request budget | —（可 release） | `ai/codex/OPS-LIVE-SHADOW1-FIX1 @ .claude/worktrees/ops-live-shadow1-execution（卡族保留至父卡 7/30 對帳）` | 2 | 📦已合併 | ✅已驗證 | 2026-07-28T22:46:10+08:00 |
