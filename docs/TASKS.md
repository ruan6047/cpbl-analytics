...
|---|---|---|---|---|---|---|---|---|---|
| [GAME-RECAP-WP-API1](tasks/GAME-RECAP-WP-API1.md) | INIT-GAME-RECAP | T3 | WP／WPA 參考資訊 API（揭露語意） | 待部署驗證（需部署卡，✅已驗證前不得 release） | `ai/fable-5/GAME-RECAP-WP-API1 @ .claude/worktrees/game-recap-wp-api1-execution（保留至部署驗證後結案）` | 1 | 📦已合併 | ⏸未部署 | 2026-07-27T02:26:44+08:00 |
...
| [UX-WP-DISCLOSURE1](tasks/UX-WP-DISCLOSURE1.md) | — | T3 | 賽況頁 WP 曲線誠實註記 | 待部署驗證（需部署卡，✅已驗證前不得 release） | `ai/fable-5/UX-WP-DISCLOSURE1 @ .claude/worktrees/ux-wp-disclosure1-execution（保留至部署驗證後結案）` | 1 | 📦已合併 | ⏸未部署 | 2026-07-27T02:26:44+08:00 |
