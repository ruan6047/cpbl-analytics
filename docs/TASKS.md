...
| [DEV-TRAILER-GUARD-PR-CHECKOUT1](tasks/DEV-TRAILER-GUARD-PR-CHECKOUT1.md) | None | T2 | trailer 守衛在 pull_request 觸發的 CI checkout 上恆定假陽性 | 待指派（查核者；新 context 即可，≠ 執行者） | `ai/claude-sonnet-5/DEV-TRAILER-GUARD-PR-CHECKOUT1 @ .claude/worktrees/dev-trailer-guard-pr-checkout1-execution` | 0 | 🔍待查核 | —不適用 | 2026-08-04T21:55:12+08:00 |
