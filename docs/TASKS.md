...
| [ML-FIELD-TZ1](tasks/ML-FIELD-TZ1.md) | — | T4 | Total Zone 型守備指標可行性研究 | Claude（Opus 4.8）（執行） | `ai/opus-4-8/ML-FIELD-TZ1 @ .claude/worktrees/ml-field-tz1-execution` | 1 | 🔨執行中 | —不適用 | 2026-07-20T21:45:00+08:00 |
