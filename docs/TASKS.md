...
| [ML-FIELD-TZ1](tasks/ML-FIELD-TZ1.md) | — | T4 | Total Zone 型守備指標可行性研究 | ruan6047（merge／Checkpoint） | `ai/opus-4-8/ML-FIELD-TZ1 @ .claude/worktrees/ml-field-tz1-execution` | 1 | ✅通過 | —不適用 | 2026-07-20T23:44:00+08:00 |
