...
| [INGEST-SPLITS-PA-SPLIT1](tasks/INGEST-SPLITS-PA-SPLIT1.md) | INIT-OFFICIAL-DATA1 | T4 | 查證分項重算是否同樣重複計打席 | ruan6047（裁定路線：重規劃／換執行者／人工接手／放棄） | `ai/fable-5/INGEST-SPLITS-PA-SPLIT1 @ .claude/worktrees/ingest-splits-pa-split1-execution` | 3 | 🚨已升級 | —不適用 | 2026-07-30T09:07:00+08:00 |
