...
| [DEV-REVIEW-PROMPT-BASE1](tasks/DEV-REVIEW-PROMPT-BASE1.md) | None | T2 | 查核提示詞在交付 SHA 的 worktree 內假性失敗 | 待指派（Coordinator；merge 者不得為執行者） | `ai/opus-5/DEV-REVIEW-PROMPT-BASE1 @ .claude/worktrees/adoring-taussig-0d71cb` | 1 | ✅可合併 | —不適用 | 2026-08-04T17:01:32+08:00 |
