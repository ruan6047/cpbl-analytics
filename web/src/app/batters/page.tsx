...
const COLS: Col[] = [
  ...
  { key: "h", label: "安打", fmt: "i", bar: true, tip: "安打總數（H）" },
  { key: "b2", label: "二安", fmt: "i", tone: "dim", tip: "二壘安打（2B）" },
  { key: "b3", label: "三安", fmt: "i", tone: "dim", tip: "三壘安打（3B）" },
  { key: "hr", label: "全壘打", fmt: "i", bar: true, tip: "全壘打（HR）" },
  { key: "rbi", label: "打點", fmt: "i", bar: true, tip: "打點（RBI）：因該打席而得分的隊友數" },
